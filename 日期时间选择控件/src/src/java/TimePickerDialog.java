package com.xfhk.android.client.utils;
...
import com.xfhk.android.client.R;
import com.xfhk.android.client.imp.TimePickerDialogInterface;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by zhongchao on 2017/10/24.
 */

 /** 用法
                    TimePickerDialog mTimePickerDialog = new TimePickerDialog(this.getActivity());
                    mTimePickerDialog.showDateAndTimePickerDialog();
                    mTimePickerDialog.setOnClickListener(new TimePickerDialogInterface() {
                        @Override
                        public void positiveListener() {
                            ...
                            sendTime.setText(year + "-" + month + "-" + day+ "  " +hour+":"+minute);
                        }
...
//        timePickerDialogInterface = (TimePickerDialogInterface) context;
    ...
    public void setOnClickListener(TimePickerDialogInterface dialogInterface){
